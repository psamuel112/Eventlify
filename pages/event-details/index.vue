<template>
  <div class="">
    ...
    <div class="secondary_wrapper px-10 py-8">
      <div class="">
        <div>
          <p class="title_text">By Realvest</p>
          <p>The Birthday of the CEO</p>
          <p>
        ...
        <div>
          <p>Date & Time</p>
          <div class="d-flex justify-between px-4 py-4 datetime_wrapper">
            <div>
              <p>Wednesday, 27 Nov 2022</p>
        ...
        <div>
          <v-btn class="text-none" flat>Show map</v-btn>
        ...
        <div>
          ...
          <div class="more_event d-flex">
            <div class="d-flex">
              <div>
                <img src="../../assets/images/png/p3.png" alt="" />
              </div>
              <div class="">
                <p class="more_card_heading">Realvest Global Technologies</p>
                <div class="d-flex mt-3 gap-2">
                  <p class="card_text">25K Followers</p>
                </div>
              </div>
            </div>
            <div class="">
      ...
      <div class="">
        ...
        <div class="ticket_wrapper">
          <p>Ticket base price</p>
          <p>₦8,000</p>
          <div class="d-flex gap-2 ticket_note_container">
            <img src="../../assets/images/svg/ticketnote.svg" alt="" />
            <p>Note that ticket price varies based on its type (that is regular, premium, VIP, etc.)</p>
          </div>
          <v-btn border flat class="w-100 text-none">
            Buy Ticket
          </v-btn>
        </div>
      </div>
    ...
    <div>
      <div class="d-flex justify-between align-center">
        <p class="info_heading">Similar events</p>
        <p class="see_all">See all</p>
      </div>
      <div class="card_container gap-4 mb-10">
