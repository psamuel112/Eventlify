  ...
  <div class="container mt-8">
    ...
    <div class="form_container mt-8 pb-32 px-8 md:pb-20 pt-8">
      ...
      <div class="editor">
        ...
        contentType="html"
        class="editor" theme="snow" toolbar="essential"/>
      </div>
    </div>
    ...
    <div class="d-flex justify-end gap-4 mt-8 mb-16">
      <button  class="back_btn body2_bold purple90 text-none py-3 px-10" > Back </button>
      <button @click="submitForm" class="text-none nxt_btn py-3 px-10"> Continue </button>
    </div>
  </v-form>
  </div>
</template>
